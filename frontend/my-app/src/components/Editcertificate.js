    ...
    <div>
     ...
     <div className="body">
      ...
      <div className=" d-flex m-1">
        ...
        <button className="btn btn-warning btn-sm mt-2 m-2 rounded">Save Changes</button>
        <button className="btn btn-danger btn-sm mt-2 m-2 rounded">Delete Certificate</button>
      </div>
